...
CREATE TABLE IF NOT EXISTS unidade_curricular_andamento (
 unidade_curricular_id BIGINT NOT NULL,
 ...
 unidade_curricular_status ENUM('TRANCADA','CURSANDO','CONLUIDA','PENDENTE') NOT NULL,
	FOREIGN KEY (unidade_curricular_id) REFERENCES unidade_curricular(id)
);

INSERT INTO unidade_curricular_andamento
(
